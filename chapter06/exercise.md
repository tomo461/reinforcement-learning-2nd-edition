...
+ \gamma \left( G_{t+1} - Q(S_{t+1},A_{t+1}) \right)
\end{aligned}
$$
...
\delta_{t+1}
+
\gamma \left( G_{t+2} - Q(S_{t+2},A_{t+2}) \right)
$$
...
Q(S_t, A_t)
+
\alpha \Big[ R_{t+1} + \gamma \mathbb{E} \left[ Q(S_{t+1}, A_{t+1}) \mid S_{t+1} \right] - Q(S_t, A_t) \Big]
\\
& \leftarrow
Q(S_t, A_t)
+
\alpha \Big[ R_{t+1} + \gamma \sum_a \pi(a \mid S_{t+1}) Q(S_{t+1}, a) - Q(S_t, A_t) \Big]
\end{aligned}
$$
...
Q_1(S_t, A_t)
+
\alpha \Bigg[ R_{t+1} + \gamma \sum_a \pi(a \mid S_{t+1}) Q_2(S_{t+1}, a) - Q_1(S_t, A_t) \Bigg]
\end{aligned}
$$
...
Q_2(S_t, A_t)
+
\alpha \Bigg[ R_{t+1} + \gamma \sum_a \pi(a \mid S_{t+1}) Q_1(S_{t+1}, a) - Q_2(S_t, A_t) \Bigg]
\end{aligned}
$$
